with 
    ...
    , stg_sales_salesorderdetail as (
        ...
        left join dim_reason on stg_sales_salesorderdetail.salesorderid = dim_reason.salesorderid
    )
    , stg_sales_salesorderheader as (
        ...
        left join dim_region on stg_sales_salesorderheader.billtoaddressid = dim_region.addressid
    )
    , 
    final as (
        select 
